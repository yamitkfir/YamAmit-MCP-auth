...
|---|---|---|---|---|---|
| 1 | `no-authentication-remote` | Ask the server "list your tools" without logging in. If it answers, **anyone on the internet can use this server.** | **MCP Transports §Security** — servers SHOULD authenticate every connection, and a protected one MUST answer `401` | No — authentication is a `SHOULD` | critical |
